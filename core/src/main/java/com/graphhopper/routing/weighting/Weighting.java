...
public interface Weighting {
    ...
    /**
     * Like {@link #calcEdgeWeight(EdgeIteratorState, boolean)}, but also taking into account the previous or next
     * edge.
    ...
    /**
     * This method calculates the weighting a certain edgeState should be associated with. E.g. a high
